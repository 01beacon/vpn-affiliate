...
const screenshots = [
  {
    src: "/images/nordvpn-look/windows-laptop-not-connected-us.png",
    alt: "NordVPN inte ansluten – Windows",
    caption: "Ej ansluten – välj land och klicka Quick Connect.",
  },
  {
    src: "/images/nordvpn-look/windows-laptop-connected-us.png",
    alt: "NordVPN ansluten – Windows",
    caption: "Ansluten till VPN (Lithuania).",
  },
  {
    src: "/images/nordvpn-look/windows-laptop-meshnet-us.png",
    alt: "NordVPN Meshnet – Windows",
    caption: "Meshnet – koppla ihop enheter och dela filer säkert.",
  },
  {
    src: "/images/nordvpn-look/windows-laptop-settings-us.png",
    alt: "NordVPN inställningar – Windows",
    caption: "Inställningar – Kill Switch, Split Tunneling m.m.",
  },
];

export default function NordVPNLookSectionWindows() {
  ...
  return (
    <section className="max-w-3xl mx-auto my-12 px-4">
      <h2 className="text-xl md:text-2xl font-bold mb-6 text-center text-gray-900 dark:text-gray-100">
        Så ser NordVPN ut på <span className="text-blue-700">Windows</span>
      </h2>
    ...
    focus:outline-none shadow-lg transition"
      ...
      <div className="text-xs text-gray-500 dark:text-gray-400 mt-6 text-center">
        Fler guider för <span className="font-bold text-blue-700">Android, iPhone, Mac</span> och <span className="font-bold text-blue-700">Smart TV</span> kommer snart!
      </div>
    </section>
  );
}
